...
export class SeedConfig {
  ...
  */
  ...
  TEMPLATE_CONFIG = {
    /**
     * Used to detect `user` property values to be HTML-escaped.
     *
    ...
    /**
     * Used to detect `user` property values to inject.
     *
     * @memberOf _.templateSettings
     * @type {RegExp}
     */
    ...
    /**
     * Used to reference the user object in the template text.
     *
     * @memberOf _.templateSettings
     * @type {string}
     */
